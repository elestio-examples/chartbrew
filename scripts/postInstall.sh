...
# curl 'https://chartbrew-yu-u353.vm.elestio.app/api/user' \
#   -H 'authority: chartbrew-yu-u353.vm.elestio.app' \
...
#   -H 'origin: https://chartbrew-yu-u353.vm.elestio.app' \
#   -H 'referer: https://chartbrew-yu-u353.vm.elestio.app/signup' \
...
#   --data-raw '{"name":"yoyo","email":"yoyoh@gmail.com","password":"Test1234#"}' \
#   --compressed